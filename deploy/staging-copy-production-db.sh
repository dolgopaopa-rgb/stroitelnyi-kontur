...
docker compose -f docker-compose.staging.yml up -d staging_app
STAGING_APP_CONTAINER="$(docker compose -f docker-compose.staging.yml ps -q staging_app)"
...
docker compose -f docker-compose.staging.yml restart staging_app
