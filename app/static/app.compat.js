(() => {
  ...
  function updateEstimateFileDialogMode() {
    ...
    if (submitButton) {
      submitButton.textContent = isLinkMode ? "Сохранить ссылку и комментарий" : isCommentMode ? "Сохранить комментарий" : "Сохранить файлы";
    }
