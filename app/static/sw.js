const CACHE_NAME = "stroitelnyi-kontur-20260606-draft-files";
const CORE_ASSETS = [
  "/",
  "/static/styles.css?v=20260606-draft-files",
  "/static/app.js?v=20260606-draft-files",
  "/static/manifest.webmanifest?v=20260606-draft-files",
