...
- Fixes applied: единый breakpoint, компактная мобильная шапка, системные команды в «Ещё», переносы длинного текста, fallback медиа, русские названия журнала, прямые маршруты.
