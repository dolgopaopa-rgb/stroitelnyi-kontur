...
def check_repository_ui_contracts(checks: list[Check], recommendations: list[Recommendation]) -> None:
    ...
    scenario_contracts = [
        ...
        (
            ...
            ["g2-logo-192.png", "app.compat.js?v=20260615-feedback-workitems", "controllerchange", "registration.update", "SKIP_WAITING", "stroitelnyi-kontur-20260615-feedback-workitems"],
